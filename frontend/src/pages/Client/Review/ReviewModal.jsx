...
export default function ReviewModal({ booking, isOpen, onClose, onSuccess }) {
    ...
    // [!code focus] 2. State for delete confirmation
    ...
    // [!code focus] 3. Just open the modal
    const handleDeleteClick = () => {
        setConfirmDeleteOpen(true);
    };

    // [!code focus] 4. Actual delete logic
                    ...
                    <DialogFooter className="border-t border-border/60 pt-4 flex justify-between">
                        {reviewId && (
                            <Button
                                ...
                                onClick={handleDeleteClick} // [!code focus] 5. Use new handler
                                disabled={isPending}
                            >
