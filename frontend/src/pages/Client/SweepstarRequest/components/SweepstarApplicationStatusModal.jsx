// src/pages/components/SweepstarRequest/SweepstarApplicationStatus.jsx
...
export default function SweepstarApplicationStatusModal({
    isPendingOnly = false,
}) {
                ...
                <CardContent className="flex flex-col items-center justify-center py-16 text-center space-y-6">
                    ...
                    <div className="space-y-2">
                        ...
                        <p className="text-muted-foreground text-lg">
                            {isPendingOnly
                                ? "Your Sweepstar application is still being reviewed by our admin team. Please wait for a response before submitting a new request."
                                : "We’ve received your Sweepstar application and will review it shortly."}
                        </p>
                    </div>
                    ...
                    <div className="flex flex-col sm:flex-row gap-3 w-full">
                        ...
                        <Button
                            ...
                            onClick={() =>
                                navigate("/dashboard/my_informations")
                            }
                        >
                            Review My Informations
